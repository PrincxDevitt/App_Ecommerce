...
const Hero = () => {
  ...
  return (
    <div className='container'>
        ...
        sm:min-h-[65px] hero-bg-color flex justify-center items-center'>
                         ...
                         <div className='grid grid-cols-1 sm:grid-cols-2'>
                           {/* text content section */}
                            ...
                            sm:text-left order-2 sm:order-1 relative z-10'>
                                <h1 className='text-2x1 sm:text-6xl lg:text-2xl font-bold'>
                                    {data.subtitle}</h1>
                                ...
                                <div>
                                    <Button text="Shop By Category" bgColor="bg-red-500" textColor="text-white" />
                                </div>
                            </div>
