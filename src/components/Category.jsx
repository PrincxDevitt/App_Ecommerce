  ...
  return (
    <div className='py-12 px-4'>
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8'>
        ...
        {/* Third col */}
        <div className='p-8 bg-gradient-to-br from-red-500 to-red-500 text-white rounded-3xl relative h-[380px] w-full sm:w-[500px] flex flex-col justify-between items-start shadow-lg mx-auto'>
          <div>
